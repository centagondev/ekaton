...
export default function HomePage() {
  return (
    <div className="flex min-h-[calc(100dvh-4rem)] flex-col items-center justify-center bg-[#FBF9F5] px-4">
      {/* 1. Integrated Reusable Navbar */} {/* 2. Hero Section */}{" "}
      <main className="flex flex-1 flex-col items-center justify-center px-4 py-16 text-center">
        {" "}
        <div className="mx-auto flex max-w-2xl flex-col items-center space-y-8">
          {" "}
          {/* Top Badge: ANONYMOUS & SECURE */}{" "}
          ...
          {/* Main Headline */}{" "}
          <h1 className="flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-4xl leading-none font-black tracking-tight text-black uppercase sm:text-6xl">
            {" "}
          ...
          <p className="max-w-lg text-base leading-relaxed font-medium text-gray-700 sm:text-lg">
            {" "}
            Real conversations with real students, completely anonymous. No
            profiles, no pressure, just connection.{" "}
          </p>{" "}
          {/* Call To Action Button with Neo-Brutalist Shadow Effect */}{" "}
          ...
          <div className="flex flex-col items-center justify-center space-y-0.5 rounded-none border-2 border-black bg-white px-5 py-2.5 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
            {" "}
